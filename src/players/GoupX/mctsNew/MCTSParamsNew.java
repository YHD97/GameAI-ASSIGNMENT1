...
public class MCTSParamsNew implements ParameterSet {
    ...
    public final int A_StarHeuristic = 1;

    public double epsilon = 1e-6;

    // Parameters
    public double K = Math.sqrt(2); //Constant for UCB1
    public int rollout_depth = 8;//10; //树从根部开始可以生长的步数
    public int heuristic_method = A_StarHeuristic; // 启发式评估状态

    // Budget settings
    //可以预设值，以确定算法何时停止执行选择行动
    ...
    public Map<String, Object[]> getParameterValues() {
        ...
        parameterValues.put("heuristic_method", new Integer[]{CUSTOM_HEURISTIC, A_StarHeuristic});
    ...
    public Map<String, String[]> constantNames() {
        ...
        names.put("heuristic_method", new String[]{"CUSTOM_HEURISTIC", "A_StarHeuristic"});
        return names;
    }
}
